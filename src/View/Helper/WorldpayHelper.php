...
class WorldpayHelper extends Helper {
	...
	public function form($options = null) {
		...
		$fields = array(
			...
			'transStatus'		=> array('type'	=> 	'hidden', 'name' => 'transStatus','value' => 'Y'),
			'desc'		=> array('type'	=> 	'hidden', 'name' => 'desc','value' => 'Heritage event booking.'),
