...
<html>
 ...
 <?php
      ...
      $customeradd  = $order['address1'].'<br>'.$order['address2'].'<br>'.$order['county'].'<br>'.$order['country'].'<br><br>'.$order['postcode'];
 ?>
 <body>
              ...
              <tr>
                ...
                <?php 
                          ...
                          $mimeArr = ['image/gif', 'image/png', 'image/jpg', 'image/jpeg'];
                              ...
                              ?>
                        <img src="<?php echo SITE_URL.'/uploads/'.strtolower($settings->source()).'/image/' .$settings->get('upload_dir'). '/square_' . $settings->get('image');?>" width="66" height="98" alt=""/>                  </td>
