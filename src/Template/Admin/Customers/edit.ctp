<div class="box box-default">
	...
	<?php echo $this->Form->create($customer, ['id' => 'form_id','type' => 'file']) ?>
	<div class="box-body">
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					<?php 
						...
						echo $this->Form->select('title', $options, ['class' => 'form-control'] ) 
					?>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<?php echo $this->Form->password('password', ['class' => 'form-control validate[minSize[6]]', 'maxlength' => 20, 'id' => 'password','value'=>'']) ?>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label>Confirm Password </label>
					<?php echo $this->Form->password('confirm_password', ['class' => 'form-control validate[equals[password]]', 'maxlength' => 20] )?>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
